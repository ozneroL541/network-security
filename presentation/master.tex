...
\include{slides/00_contents}
\include{slides/01_Firstly}
\include{slides/02_VA}
\include{slides/03_OpenVAS}
\include{slides/04_DB}
\include{slides/06_Setup}
\include{slides/05_Network}
\include{slides/07_System_Discovery}
\include{slides/50_Vulnerability_Scan}
\include{slides/51_OpenVAS_Interface}
