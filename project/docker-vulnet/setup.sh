...
iptables -I FORWARD 1 -s 172.30.0.0/22 -d 172.30.0.0/22 -j ACCEPT
# Remove the default IP addresses from the bridge interfaces
ip addr del 172.30.1.254/24 dev vulnlab1
ip addr del 172.30.2.254/24 dev vulnlab2
ip addr del 172.30.3.254/24 dev vulnlab3
# Host
# Tell your physical machine to send lab traffic to vulnbox1
ip route replace 172.30.1.0/24 via 172.30.0.2
ip route replace 172.30.2.0/24 via 172.30.0.2
ip route replace 172.30.3.0/24 via 172.30.0.2
# vulnbox1
