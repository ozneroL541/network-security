...
This task will scan Windows XP for the FTP service. Now you should have a new task created with the name you gave it, in this case \textbf{WIN XP FTP TASK} like so:
...
Now press the play button to queue it so that it will start, it will take approximately 10 minutes to complete. After the scan is done it should appear in the report tab
